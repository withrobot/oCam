...
#define INFO_BLUE_GAIN		0x0E00
#define INFO_RED_GAIN		0x0F00
#define CTRL_BLUE_GAIN		0x1E00
#define CTRL_RED_GAIN		0x1F00
#define Windows_Version		19041		//Windows_10_2020(2019 : 18363)
...
#define CTRL_BACKLIGHTCOMPENSATION			9
#define CTRL_AUTOEXPOSURE	10
...
/*Info = 0x0E00 : Get Blue Gain
Info = 0x0F00 : Get Red Gain
Info = 0x1Exx : Set Blue Gain
Info = 0x1Fxx : Set Red Gain*/
/**
 *  CamGetWhiteBalaceInfo
 *      Get WhiteBalance information.
 *
 *      - Input:
 *          CAMPTR ptrCam       : Handle of the opened camera
 *          int    Info         : Type of information
 *
 *      - Output:
 *          uint8_t             : Value Unsigned char of WhiteBalace
 *								: Failed(0) or Success(Value)
 */
LIBCAMCAP_API uint8_t CamGetWhiteBalanceInfo(const int ID, int Info);

/**
 *  CamSetWhiteBalanceInfo
 ...
 *      - Output:
 *          uint8_t             : Value Unsigned char of WhiteBalace
 *								: Failed(0) or Success(1)
 */
LIBCAMCAP_API uint8_t CamSetWhiteBalanceInfo(const int ID, int Info);
#ifdef __cplusplus
}
#endif
